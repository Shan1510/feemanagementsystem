...
<head>
    ...
    <title>Paid Students — Fee Management System</title>
    ...
    <main class="main-content">
        <div class="page-container">
            <div class="page-header">
                <div>
                    <h1>✅ Paid Students</h1>
                    <p>Records with a confirmed fee payment</p>
                </div>
                <span class="badge status-paid"><?= mysqli_num_rows($result) ?> paid</span>
            </div>
                    ...
                    <table class="data-table">
                        ...
                        <?php if (mysqli_num_rows($result) > 0):
                            ...
                            <tr>
                                ...
                                <td><?= $monthNames[(int)$row['fee_month']] ?? htmlspecialchars($row['fee_month']) ?></td>
                                <td><?= htmlspecialchars($row['fee_year']) ?></td>
                            </tr>
                            <?php endwhile;
                        else: ?>
                            <tr><td colspan="9" class="empty-state">No paid students found</td></tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
